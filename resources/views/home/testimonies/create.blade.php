                            ...
                            <form id="contact-form" class="contact-form">
                                <fieldset>
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                <textarea placeholder="Prayer Request*" class="textarea form-control" name="prayer_request" id="form-message" rows="10" cols="20" data-error="Prayer Request field is required"
                                                    required></textarea>
                                                <div class="help-block with-errors"></div>
                                            </div>
                                        </div>
