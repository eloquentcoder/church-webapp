            ...
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-wrapper">
                    <div class="kt-portlet__head-actions">
                        <a href="{{ route('admin.blog-post.create') }}" class="btn btn-brand btn-elevate btn-icon-sm">
            ...
            <div class="kt-datatable kt-datatable--default kt-datatable--brand kt-datatable--loaded" id="local_data" style="">
                <table class="kt-datatable__table" style="display: block;">
                    <thead class="kt-datatable__head"><tr class="kt-datatable__row" style="left: 0px;">
                        ...
                        <th data-field="OrderID" class="kt-datatable__cell kt-datatable__cell--sort">
                            <span style="width: 110px;">Excerpt</span>
                        </th>
                        <th data-field="OrderID" class="kt-datatable__cell kt-datatable__cell--sort">
                    ...
                    @forelse ($blogposts as $blogpost)
                        <tr data-row="0" class="kt-datatable__row" style="left: 0px;">
                            <td data-field="OrderID" class="kt-datatable__cell">
                                <span style="width: 110px;">{{$blogpost->title}}</span>
                            </td>
                            <td data-field="OrderID" class="kt-datatable__cell">
                                <span style="width: 110px;">{{$blogpost->excerpt }}</span>
                            </td>
                            <td data-field="OrderID" class="kt-datatable__cell">
                                <span style="width: 110px;">{{$blogpost->created_at }}</span>
                            </td>
                            <td data-field="CompanyName" class="kt-datatable__cell">
                                <span style="width: 110px;">
                                    <a href="{{ route('admin.blog-post.edit', $blogpost->id) }}" style="padding: 0 5px;"><i class="fa fa-list-ol"></i></a>
                                    <a href="{{route('admin.blog-post.delete', $blogpost->id)}}" style="padding: 0 5px;"><i class="fa fa-trash"></i></a>
                                </span>
                            </td>
                        </tr>
                    @empty
