...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
    <div class="kt-portlet kt-portlet--mobile">
        ...
        <!--begin::Form-->
        <form class="kt-form" method="POST" action="{{ route('admin.blog-post.create.post') }}" enctype="multipart/form-data">
            ...
            <div class="kt-portlet__body">
                ...
                <div class="form-group row">
                    <div class="col-md-12">
                        ...
                        <textarea class="form-control" name="post" placeholder="Enter Blog Post" rows="4"></textarea>
                    </div>
                </div>
            </div>
