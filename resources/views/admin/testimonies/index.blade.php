            ...
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-wrapper">
                    <div class="kt-portlet__head-actions">
                        <a href="{{ route('admin.testimony.create') }}" class="btn btn-brand btn-elevate btn-icon-sm">
                    ...
                    @forelse ($testimonies as $testimony)
                        <tr data-row="0" class="kt-datatable__row" style="left: 0px;">
                            <td data-field="OrderID" class="kt-datatable__cell">
                                <span style="width: 110px;">{{$testimony->name}}</span>
                            </td>
                            <td data-field="OrderID" class="kt-datatable__cell">
                                <span style="width: 110px;">{{$testimony->title }}</span>
                            </td>
                            <td data-field="Country" class="kt-datatable__cell">
                                <span style="width: 110px;">{{ $testimony->phone_number }}</span>
                            </td>
                            <td data-field="CompanyName" class="kt-datatable__cell">
                                <span style="width: 110px;">
                                    <a href="{{route('admin.testimony.delete', $testimony->id)}}" style="padding: 0 5px;"><i class="fa fa-trash"></i></a>
                                </span>
                            </td>
                        </tr>
                    @empty
