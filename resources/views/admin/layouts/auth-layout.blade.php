...
<html lang="en">
	...
	<head>
		<base href="../../../">
		<meta charset="utf-8" />
		<title>Prophetic Tribe Admin | Login</title>
		...
		<link href="{{ asset('dashboard/css/pages/login/login-2.css')}}" rel="stylesheet" type="text/css" />
	...
	<body style="background-image: url({{ asset('dashboard/media/demos/demo8/bg-1.jpg')}})" class="kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--enabled kt-subheader--transparent kt-page--loading">
		...
		<script src="{{ asset('dashboard/js/pages/custom/login/login-general.js')}}" type="text/javascript"></script>
