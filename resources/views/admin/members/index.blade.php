            ...
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-wrapper">
                    <div class="kt-portlet__head-actions">
                        <a href="{{ route('admin.members.create') }}" class="btn btn-brand btn-elevate btn-icon-sm">
                ...
                <tbody class="kt-datatable__body" style="">
                    @forelse ($members as $item)
                        <tr data-row="0" class="kt-datatable__row" style="left: 0px;">
                            <td data-field="OrderID" class="kt-datatable__cell">
                                <span style="width: 110px;">{{$item->first_name}}</span>
                            </td>
                            <td data-field="OrderID" class="kt-datatable__cell">
                                <span style="width: 110px;">{{$item->last_name }}</span>
                            </td>
                            <td data-field="OrderID" class="kt-datatable__cell">
                                <span style="width: 110px;">{{$item->address }}</span>
                            </td>
                            <td data-field="OrderID" class="kt-datatable__cell">
                                <span style="width: 110px;">{{$item->phone_number }}</span>
                            </td>
                    ...
                    @empty
                        ...
                        <div class="container" style="text-align:center">
                            <span> No Church Members Added Yet </span>
                        </div>
