            ...
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-wrapper">
                    <div class="kt-portlet__head-actions">
                        <a href="{{ route('admin.events.create') }}" class="btn btn-brand btn-elevate btn-icon-sm">
                ...
                <table class="kt-datatable__table" style="display: block;">
                    <thead class="kt-datatable__head"><tr class="kt-datatable__row" style="left: 0px;">
                        ...
                        <th data-field="ShipDate" class="kt-datatable__cell kt-datatable__cell--sort">
                            <span style="width: 110px;">Country</span>
                        </th>
                        <th data-field="ShipDate" class="kt-datatable__cell kt-datatable__cell--sort">
                    ...
                    @forelse ($events as $event)
                        <tr data-row="0" class="kt-datatable__row" style="left: 0px;">
                            <td data-field="OrderID" class="kt-datatable__cell">
                                <span style="width: 110px;">{{$event->name}}</span>
                            </td>
                            <td data-field="OrderID" class="kt-datatable__cell">
                                <span style="width: 110px;">{{$event->starts }}</span>
                            </td>
                            <td data-field="Country" class="kt-datatable__cell">
                                <span style="width: 110px;">{{ $event->venue }}</span>
                            </td>
                            <td data-field="CompanyName" class="kt-datatable__cell">
                                <span style="width: 110px;">{{ $event->country }}</span>
                            </td>
                            <td data-field="CompanyName" class="kt-datatable__cell">
                                <span style="width: 110px;">
                                    <a href="{{ route('admin.event.edit', $event->id) }}" style="padding: 0 5px;"><i class="fa fa-list-ol"></i></a>
                                    <a href="{{route('admin.event.delete', $event->id)}}" style="padding: 0 5px;"><i class="fa fa-trash"></i></a>
                                </span>
                            </td>
                        </tr>
                    @empty
